...
We strongly recommend using the community upload script to prepare your contribution.
This script automatically generates all required metadata and ensures your submission follows the correct structure. While use of the script is not mandatory, it greatly streamlines the process and helps maintain consistency across the repository.
